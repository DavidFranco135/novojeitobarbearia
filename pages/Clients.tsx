            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                 <label className="text-[10px] font-black text-zinc-600 uppercase tracking-widest ml-1">
                   Senha do Portal <span className="normal-case text-zinc-700">(opcional — cliente pode definir depois)</span>
                 </label>
                 <input type="password" placeholder="Deixe vazio para o cliente definir no primeiro acesso" value={formData.password} onChange={e => setFormData({...formData, password: e.target.value})} className="w-full bg-white/5 border border-white/10 p-5 rounded-2xl outline-none text-white font-bold focus:border-[#C58A4A]/50" />
                 {!formData.password && (
                   <p className="text-[9px] text-zinc-600 font-bold ml-1">
